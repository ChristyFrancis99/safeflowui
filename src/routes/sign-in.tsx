    ...
    <div className="min-h-screen bg-offwhite p-3 md:p-8">
      <div className="mx-auto max-w-6xl overflow-hidden rounded-[32px] border border-border bg-background shadow-[var(--shadow-float)]">
        <div className="grid min-h-[calc(100vh-2rem)] lg:grid-cols-[1.08fr_0.92fr]">
          <Reveal><div className="relative hidden h-full min-h-[calc(100vh-2rem)] overflow-hidden bg-card lg:block"><div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,#8957e533,transparent_45%)]" /><div className="absolute inset-0 flex items-center justify-center"><div className="rounded-full border border-violet/20 bg-violet/5 p-16"><Logo size="lg" rounded="xl" /></div></div></div></Reveal>
          <Reveal delay={80}><div className="flex flex-col justify-center bg-background px-4 py-8 sm:px-6 lg:px-10 xl:px-14"><div className="mx-auto w-full max-w-md">
